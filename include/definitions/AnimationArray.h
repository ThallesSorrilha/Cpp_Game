...
const std::array<std::vector<int>, 12> AnimationArray = {
    ...
    std::vector<int>{std::to_underlying(SpriteCutID::Attack_Left1), std::to_underlying(SpriteCutID::Attack_Left2), std::to_underlying(SpriteCutID::Attack_Left3), std::to_underlying(SpriteCutID::Attack_Left4)},                                                                                                                                                                                                             // 9
    std::vector<int>{std::to_underlying(SpriteCutID::Attack_Up1), std::to_underlying(SpriteCutID::Attack_Up2), std::to_underlying(SpriteCutID::Attack_Up3), std::to_underlying(SpriteCutID::Attack_Up4)},                                                                                                                                                                                                             // 10
